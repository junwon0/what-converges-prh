...
def prh_metric_spec(metric: str, *, topk: int) -> tuple[Callable, float]:
    ...
    metric_map = {
        ...
        # topology metrics
        "mst_overlap": ("mst_overlap", 1.0),
        "mst_min_overlap": ("mst_min_overlap", 1.0),
        "rtd": ("rtd", 1.0),
        "rtd_lite": ("rtd_lite", 1.0),

        "pd0_bottleneck": ("pd0_bottleneck", 1.0),
        "pd1_bottleneck": ("pd1_bottleneck", 1.0),
        "pd01_bottleneck": ("pd01_bottleneck", 1.0),

        "pd0_wasserstein": ("pd0_wasserstein", 1.0),
        "pd1_wasserstein": ("pd1_wasserstein", 1.0),
        "pd01_wasserstein": ("pd01_wasserstein", 1.0),
    }

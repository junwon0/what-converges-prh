...
This module provides model loading utilities for the video--text
extension used in this study.
...
def get_video_models(modelset: str = "videoprh") -> List[str]:
    """Get video models for V2T experiments.

    Args:
        modelset: Which model set to use. Options:
            - "videoprh": the 11 video/frame-model checkpoints used in the paper
